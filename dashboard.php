...
$query12 = "SELECT * FROM tbl_employee WHERE `status`!=3";
$result12 = $conn->query($query12);
$total = $result12->num_rows;
...
var data = {
    ...
    datasets: [{
        data: [<?php echo $Normal; ?>, <?php echo $Leave; ?>, <?php echo $OfficialTime; ?>, <?php echo $OfficialBusiness; ?>, <?php echo $Health; ?>],
        label: 'Total Distribution',
		backgroundColor: [
