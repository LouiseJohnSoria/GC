													...
													<?php foreach ($teams as $index => $row) : ?>
														<tr>
															...
															<?php if (isset($_SESSION['username'])) : ?>
																...
																<td>
																	<?php if ($_SESSION['role'] == 'administrator') : ?>
																		<!-- <a type="button" data-toggle="tooltip" href="model/remove_teams.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this team?');" class="btn btn-link btn-danger" data-original-title="Remove">
